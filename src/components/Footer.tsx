            ...
            <div className="space-y-4">
              <div className="space-y-2" style={{ fontFamily: '"Hanken Grotesk", sans-serif', fontSize: '1.5rem' }}>
                ...
                <div className="flex space-x-4 mt-4">
                  <Link href="https://www.linkedin.com/in/marie-feutrier-mh05/" className="hover:opacity-80 transition-opacity" onClick={() => trackExternalLink('https://www.linkedin.com/in/marie-feutrier-mh05/', 'LinkedIn', 'linkedin')}>
                    <Linkedin className="h-5 w-5 md:h-8 md:w-8" style={{ color: '#1C1C1C' }} />
                  </Link>
                  <Link href="https://www.instagram.com/marie.feutrier/" className="hover:opacity-80 transition-opacity" onClick={() => trackExternalLink('https://www.instagram.com/marie.feutrier/', 'Instagram', 'instagram')}>
                    <Instagram className="h-5 w-5 md:h-8 md:w-8" style={{ color: '#1C1C1C' }} />
                  </Link>
                  <Link href="https://www.pinterest.com/mariefeutrier/" className="hover:opacity-80 transition-opacity" onClick={() => trackExternalLink('https://www.pinterest.com/mariefeutrier/', 'Pinterest', 'pinterest')}>
