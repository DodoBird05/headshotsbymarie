...
export default function MesaHeadshotsPage({ frontmatter }: MesaHeadshotsProps) {
  ...
  const getZoneColors = (sectionIndex: number): ZoneColors => {
    ...
    const reverseBgs = [
      ...
      'linear-gradient(180deg, #7A7570, #F5F0EB)'
    ]
    const reverseTexts = ['#F5F0EB', '#F5F0EB', '#F5F0EB', '#1C1C1C']
    const reverseDarks = [true, true, true, false]
    return {
  ...
  return (
    <>
      <Head>
        ...
        <link rel="canonical" href="https://headshotsbymarie.com/mesa-headshots/" />
        ...
        <meta property="og:url" content="https://headshotsbymarie.com/mesa-headshots/" />
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify(generateServiceSchema({
              name: 'Professional Headshot Photography in Mesa',
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify(generateBreadcrumbSchema([
              { name: 'Mesa Headshots', url: '/mesa-headshots/' }
            ]))
          }}
        />
      </Head>
...
export async function getStaticProps() {
  const filePath = path.join(process.cwd(), 'content', 'mesa-headshots.md')
