...
interface ChandlerHeadshotsProps {
  frontmatter: {
    title: string
    description: string
    heroTitle: string
  ...
  return (
    <>
      <Head>
        ...
        <link rel="canonical" href="https://headshotsbymarie.com/chandler-headshots/" />
        ...
        <meta property="og:url" content="https://headshotsbymarie.com/chandler-headshots/" />
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify(generateServiceSchema({
              name: 'Professional Headshot Photography in Chandler',
              description: frontmatter.description,
              url: '/chandler-headshots/',
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify(generateBreadcrumbSchema([
              { name: 'Chandler Headshots', url: '/chandler-headshots/' }
            ]))
          }}
        />
      </Head>
        ...
        {frontmatter.sections.slice(frontmatter.testimonial1Position).map((section, i) => {
          ...
          return (
            <div key={sectionIndex}>
              ...
              {/* Insert 5-Image Row 2 */}
              {sectionIndex === frontmatter.imageRow2Position && (
                <section style={{ backgroundColor: '#1C1C1C' }}>
                  <div className="grid grid-cols-2 lg:grid-cols-5 gap-0">
                    {frontmatter.imageRow2.map((image, index) => (
...
export async function getStaticProps() {
  const filePath = path.join(process.cwd(), 'content', 'chandler-headshots.md')
