...
export default function Top8Page() {
  ...
  // Sample top 8 items - you can replace this with actual data later
  const top8Items = [
    {
      id: 1,
      title: 'Executive Leadership Portrait',
      description: 'Professional headshot for CEO, combining authority with approachability.',
      image: '/images/top8-placeholder-1.jpg'
    },
    {
      id: 2,
      title: 'Personal Branding Session',
      description: 'Complete image library for entrepreneur, showcasing personality and professionalism.',
      image: '/images/top8-placeholder-2.jpg'
    },
    {
      id: 3,
      title: 'Medical Professional',
      description: 'Warm and trustworthy portrait for healthcare provider.',
      image: '/images/top8-placeholder-3.jpg'
    },
    {
      id: 4,
      title: 'Creative Director',
      description: 'Bold, artistic headshot reflecting creative vision.',
      image: '/images/top8-placeholder-4.jpg'
    },
    {
      id: 5,
      title: 'Legal Professional',
      description: 'Confident and polished portrait for attorney.',
      image: '/images/top8-placeholder-5.jpg'
    },
    {
      id: 6,
      title: 'Entrepreneur Launch',
      description: 'Dynamic series for startup founder building their brand.',
      image: '/images/top8-placeholder-6.jpg'
    },
    {
      id: 7,
      title: 'Real Estate Professional',
      description: 'Approachable and trustworthy portrait for realtor.',
      image: '/images/top8-placeholder-7.jpg'
    },
    {
      id: 8,
      title: 'Tech Industry Leader',
      description: 'Modern, professional portrait for tech executive.',
      image: '/images/top8-placeholder-8.jpg'
    }
  ]
  ...
  return (
    <>
      <Head>
        <title>Top 8 - Portraits By Marie</title>
        <meta name="description" content="Top 8 favorite portrait sessions and projects by Marie" />
      </Head>
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{
              ...
              {top8Items.slice(1).map((item, index) => (
                <article
                  key={item.id}
                  style={{
                    background: '#f5f5f5',
