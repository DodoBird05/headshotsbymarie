...
interface ScottsdaleHeadshotsProps {
  frontmatter: {
    title: string
    description: string
    heroTitle: string
...
export default function ScottsdaleHeadshotsPage({ frontmatter, content }: ScottsdaleHeadshotsProps) {
  useScrollReveal()
  let imageIndex = 0
  ...
  return (
    <>
      <Head>
        ...
        <link rel="canonical" href="https://headshotsbymarie.com/scottsdale-headshots/" />
        ...
        <meta property="og:url" content="https://headshotsbymarie.com/scottsdale-headshots/" />
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify(generateServiceSchema({
              name: 'Professional Headshot Photography in Scottsdale',
              description: frontmatter.description,
              url: '/scottsdale-headshots',
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify(generateBreadcrumbSchema([
              { name: 'Scottsdale Headshots', url: '/scottsdale-headshots' }
            ]))
          }}
        />
      </Head>
...
export async function getStaticProps() {
  const filePath = path.join(process.cwd(), 'content', 'scottsdale-headshots.md')
