...
interface GilbertHeadshotPhotographerProps {
  frontmatter: {
    title: string
    description: string
    heroImage: string
...
export default function GilbertHeadshotPhotographerPage({ frontmatter }: GilbertHeadshotPhotographerProps) {
  ...
  return (
    <>
      ...
      {/* Content Sections with Image Row and Testimonials inserted at positions */}
      {frontmatter.sections.map((section, sectionIndex) => {
        ...
        return (
          <div key={sectionIndex}>
            ...
            {/* Insert Testimonial 2 (image left, quote right) */}
...
export async function getStaticProps() {
  const filePath = path.join(process.cwd(), 'content', 'gilbert-headshot-photographer.md')
