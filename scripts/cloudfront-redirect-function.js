...
function handler(event) {
  ...
  var r = {
    ...
    '/what-does-your-headshot-smile-says-about-you/':'/tips-guides/should-you-smile-in-headshot/',
    '/dos-and-donts-for-business-headshots-and-profile-pictures/':'/how-to-prepare/',
    ...
    '/best-colors-for-headshots-matching-skin-tones-and-personal-branding/':'/tips-guides/blending-authority-approachability-wardrobe/',
    '/do-you-need-makeup-for-your-headshot/':'/tips-guides/best-makeup-for-headshots/',
    ...
    '/open-shade/':'/tips-guides/best-locations-outdoor-headshots-phoenix/',
    ...
    '/how-to-prepare-for-your-photoshoot/':'/how-to-prepare/',
    '/what-happens-when-you-are-late-to-your-photo-session/':'/how-to-prepare/',
    ...
    '/corporate-headshots-photographer-phoenix/':'/corporate-headshots/',
    ...
    '/tag/acting-headshots/':'/phoenix-actor-headshots/',
    ...
    '/tag/photoshoot-makeup/':'/tips-guides/best-makeup-for-headshots/',
    '/linkedin-headshots-audit-phoenix/':'/linkedin-headshots/',
    '/three-mistakes-professionals-make-before-a-photoshoot/':'/how-to-prepare/',
    ...
    '/to-smile-or-not-to-smile-the-great-headshot-dilemma/':'/tips-guides/should-you-smile-in-headshot/',
    '/envira/alec-fav/':'/portraits/',
    '/acting-hedashots-in-phoenix/':'/phoenix-actor-headshots/',
    '/actor-headshots/':'/phoenix-actor-headshots/',
    '/c/':'/'
  };
