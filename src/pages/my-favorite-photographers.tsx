    ...
    <>
      <Head>
        ...
        <style>{`
          ...
          /* Mobile: hide overlay title, show sidebar title */
          ...
          /* Desktop: show overlay title, hide sidebar title */
          @media (min-width: 769px) {
            .overlay-title { display: block !important; }
      ...
      <Layout title="My Favorite Photographers" description="The photographers who inspire my work">
        ...
        {/* Sticky Overlay Title - Desktop only */}
        <div className="overlay-title" style={{
          position: 'fixed',
          bottom: '20px',
          right: '20px',
          fontSize: '48px',
