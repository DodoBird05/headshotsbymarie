  ...
  return (
    <>
      <Head>
        ...
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({ '@context': 'https://schema.org', '@type': 'LocalBusiness', '@id': `${seoConfig.siteUrl}/#business`, name: seoConfig.businessName, aggregateRating: generateAggregateRating('84'), review: frontmatter.testimonials.map(t => ({ '@type': 'Review', reviewBody: t.quote, datePublished: t.datePublished || '2026-01-01', author: { '@type': 'Person', name: t.author }, reviewRating: { '@type': 'Rating', ratingValue: '5', bestRating: '5' } })) }) }} />
