...
whatsIncluded:
  ...
  items:
    ...
    - "Multiple outfit options so you have choices"
    - "Files formatted to current ERAS specifications, ready to upload"
    - "Both square and portrait crops in case the system requires either format"
    - "Fast turnaround: delivered within 5 days (rush available if needed)"
  imagePath: "/images/ERAS/Residency-Application-Photo-Male-Student-Dress-Shirt-Phoenix.webp"
...
erasRequirements:
  ...
  rows:
    ...
    - requirement: "Dimensions"
      specification: "5\" x 5\" (square) new format"
    - requirement: "Backup"
      specification: "2.5\" x 3.5\" (portrait) some systems still require this"
    - requirement: "Frame"
      specification: "Head and shoulders, front-facing"
    - requirement: "Background"
      specification: "Neutral, no distractions"
    - requirement: "Color"
      specification: "Must be in color"
  footnote: "I deliver both formats so you're covered regardless of what the upload portal requires."
  imagePath: "/images/ERAS/ERAS-Headshot-Female-Student-Gray-Blazer-Glasses-Phoenix.webp"
...
whatToWear:
  ...
  doItems:
    ...
    - "Button-down shirts, blouses, blazers"
    - "Something you'd wear to meet your future program director"
  dontItems:
    - "White coat (save it for after you match)"
    - "Scrubs"
...
whatToExpect:
  ...
  steps:
    ...
    - "I'll guide you through posing so you don't need to know what to do"
